...
def mock_stride_client():
    ...
    # Mock usage response
    client.get_usage = AsyncMock(return_value={
        "plan": "FREE",
        "analyses_used": 5,
        "analyses_limit": 50,
...
def mock_github_client():
    ...
    client.get_issue_description.return_value = "Add user authentication with OAuth support"
    
    # Mock comment posting
    client.create_comment.return_value = "https://github.com/test/repo/issues/42#issuecomment-123456"
