...
async def test_client():
    ...
    try:
        ...
        print(f"   Analyses Used: {usage.get('analyses_used', 0)}/{usage.get('analyses_limit', 'unlimited')}")
    ...
    try:
        ...
        if summary:
            print(f"   Summary: {summary.get('total', 0)} total, {summary.get('high', 0)} high, {summary.get('medium', 0)} medium")
    except Exception as e:
